...
On Error GoTo Err:
    ...
    File = App.path & dirFile & "\" & Format(Now, "FS_DD_MM_YYYY-hh_mm_ss") & ".jpg"
    ...
    AddtoRichTextBox frmMain.RecTxt, "La foto se ha guardado en " & File, 0, 200, 200, False, False, True
Exit Sub

Err:
    Call AddtoRichTextBox(frmMain.RecTxt, Err.number & "-" & Err.Description, 0, 200, 200, False, False, True)
